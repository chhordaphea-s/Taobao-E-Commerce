    ...
    <div class="customerService">
        ...
        <div class="Leftside">
            ...
            <div class="selectcountry-container">
                <select class="country" name="Country" id="" placeholder="Country ">
                    <option class="option" value="" disabled selected>Country</option>
                    <option value="S">Cambodia</option>
                    <option value="M">Vietname</option>
                </select>
                <select class="country" name="Country" id="" placeholder="State ">
                    <option class="option" value="" disabled selected>State</option>
                    <option value="S">Cambodia</option>
                    <option value="M">Vietname</option>
                </select>
